...
import './Header.css';
import logo from '../../assets/img/logo_transparen1t.png'
...
function Notification(props) {
    ...
    return (
        <UncontrolledButtonDropdown>
            <DropdownToggle className="bell-btn" color="none" onClick={handleClick}>
                {
                    (props.hasNew)
...
const Header = (props) => {
    ...
    return (
        <Navbar color="light" light expand="xs">
            <Container>
                <NavbarBrand><img src={logo} alt="" width={'200px'}/></NavbarBrand>
                <Nav className="ml-auto" navbar>
                    {!urls.includes(path) &&
                        <NavItem>
                            <Notification className="bell-btn"
                            me={me}
